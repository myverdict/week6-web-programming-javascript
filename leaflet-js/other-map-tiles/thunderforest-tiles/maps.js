...
let tileURL = 'https://tile.thunderforest.com/atlas/{z}/{x}/{y}{r}.png?apikey=e42d0912b78042d4ac5a38d0d40ed3a9'
...
let mnZooMarker = L.marker(mnZooCoordinates)
    .bindPopup(`<a href="https://mnzoo.org/" target="_blank"><b>Minnesota Zoo<b></a>`)
    .addTo(mymap)
